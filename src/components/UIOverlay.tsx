...
const UIOverlay: React.FC<{ scrollProgress?: number; skyColor?: string }> = ({ scrollProgress = 0, skyColor = '#2563eb' }) => {
    ...
    const ONBOARD_START = 0.73;
    const ONBOARD_PEAK = 0.81;
    const ONBOARD_END = 0.90;
    ...
    return (
        ...
        <section id="hero" style={{ position: 'absolute', top: 0, left: 0, width: '100vw', height: '100vh', pointerEvents: 'none', zIndex: 60, overflow: 'visible' }}>

            {/* HEADER: Top Right - Always visible throughout scroll */}
            <header
                style={{
                    position: 'absolute',
                    top: 0,
            ...
            >
                <motion.div
                    ...
                    transition={{ 
                        ...
                        y: { delay: 2.6, duration: 2, repeat: Infinity, ease: 'easeInOut' }
                    }}
                >
